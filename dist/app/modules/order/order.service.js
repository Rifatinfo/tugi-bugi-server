...
const createOrderService = (_a) => __awaiter(void 0, [_a], void 0, function* ({ payload, userId, userEmail, }) {
    ...
    const result = yield prisma_1.default.$transaction((tx) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const orderItems = yield Promise.all(cartItems.map((item) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const variant = yield tx.variant.findFirst({
                where: {
            ...
            return {
                ...
                size: item.size,
                sku: product.sku,
                productImage: ((_b = product.images[0]) === null || _b === void 0 ? void 0 : _b.url) || null,
            };
        })));
        ...
        const order = yield tx.order.create({
            data: {
                ...
                deliveryCharge,
                checkoutEmail: userEmail !== null && userEmail !== void 0 ? userEmail : payload.checkoutEmail,
    ...
    if (paymentMethod === "COD") {
        ...
        invoiceUrl = yield (0, invoiceUrl_1.saveInvoicePdf)(pdfBuffer, `invoice-${result.id}`);
      ...
      <div style="font-family: Arial, sans-serif; padding: 20px;">
        ...
        ${result.items
              ...
              <div style="display:flex; gap:10px; margin-bottom:10px; border-bottom:1px solid #eee; padding-bottom:10px;">
                ...
                <img 
                  src="${((_a = item.product) === null || _a === void 0 ? void 0 : _a.thumbnailImage) || "https://via.placeholder.com/70"}"
