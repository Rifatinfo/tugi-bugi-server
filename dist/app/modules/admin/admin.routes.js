...
router.get('/:id', (0, auth_1.default)(client_1.UserRole.ADMIN), admin_controller_1.AdminController.getByIdFromDB);
...
router.delete('/soft/:id', (0, auth_1.default)(client_1.UserRole.ADMIN), admin_controller_1.AdminController.softDeleteFromDB);
